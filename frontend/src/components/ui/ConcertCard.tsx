...
export default function ConcertCard({ name, description, totalSeats, onDelete }: ConcertCardProps) {
  return (
    <div className="flex flex-col rounded-md border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-auto flex items-center justify-between">
        ...
        <button 
          onClick={onDelete}
          className="flex items-center gap-2 rounded-md bg-[#E84E4E] px-6 py-2.5 text-white transition-colors hover:bg-red-600"
        >
